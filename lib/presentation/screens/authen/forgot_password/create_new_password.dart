...
class CreatePassword extends StatefulWidget {
  final String phone;
  const CreatePassword({Key? key, required this.phone}) : super(key: key);
        ...
        child: BlocListener<ForgotPasswordBloc, ForgotPasswordState>(
          listener: (context, state) {
            if (state is NewPasswordCreated) {
              final snackBar = SnackBar(
                ...
                content: AwesomeSnackbarContent(
                  title: 'Success',
                  message:
                      'Create new password successfully. Please log in with newly created password',
            ...
            if (state is CreateNewPasswordError) {
              setState(() {
                error = "Cannot create new password. Please contact support!";
              });
            }
          },
              ...
              child: Column(
                children: [
                  Padding(
                      ...
                      child: const Text(
                        'Setup new password',
                        style: TextStyle(fontSize: 26, fontFamily: "times"),
                      )),
                  Padding(
                    padding: EdgeInsets.only(top: screenHeight * 0.1),
                    child: Builder(
          ...
          child: TextButton(
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                context.read<ForgotPasswordBloc>().add(SubmitNewPassword(
                    widget.phone, newPasswordController.text));
              }
            },
            child: state is CreatingNewPassword
